        ...
        <div className="contact">
            <div className="contact-container">
                <div className="contact-info">
                    ...
                    <p><strong>Telefoon:</strong> +32 470 62 15 45</p>
                    <p><strong>Email:</strong> info@ilcuorediloco.it</p>
                    <p><strong>Adres:</strong> Via Giuseppe Verdi, 23, 70010 Locorotondo BA, Italia</p>
                </div>
